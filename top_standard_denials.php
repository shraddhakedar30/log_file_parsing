...
if (isset($_GET['file'])) {
    ...
    if (($handle = fopen($logFilePath, 'r')) !== false) {
        while (($line = fgets($handle)) !== false) {
            if (strpos($line, 'proto= udp') !== false && strpos($line, 'msg="Webwall: packet dropped"') !== false) {
                ...
                if ($sportMatches && $dstMatches && $dportMatches) {
...
<head>
    ...
    <title>Top 10 Denials (Standard Destination Ports)</title>
    <link href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-4">
        <h2>Top 10 Denials (Standard Destination Ports)</h2>
